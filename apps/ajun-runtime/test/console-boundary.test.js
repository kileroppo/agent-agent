...
async function readConsoleScripts() {
  return (await Promise.all([
    ...
    'task-record-origin-view.js',
    'task-record-presentation.js',
    'task-record-report-formatter.js',
    'task-record-subtask-drawer.js',
    'task-record-workbench-filters.js',
    'task-record-workbench-helpers.js',
    'task-record-workbench-views.js',
