...
import { ARTIFACT_TYPE_LABELS, formatArtifactLabel, getArtifactPreviewTitle, formatStructuredReportText, cleanHumanReadableText, agentNameZh, } from './task-record-report-formatter.js';
export { ARTIFACT_TYPE_LABELS, formatArtifactLabel, getArtifactPreviewTitle, formatStructuredReportText, cleanHumanReadableText, agentNameZh, };
export function renderArtifact(artifact, options = {}) {
    ...
    const isSummaryTrivial = !cleanSummary || (taskTitle && (cleanSummary === taskTitle ||
    ...
    const isPreviewDuplicate = Boolean(cleanPreview && cleanSummary && (cleanPreview === cleanSummary ||
        cleanPreview === `【核心结论】\n${cleanSummary}` ||
