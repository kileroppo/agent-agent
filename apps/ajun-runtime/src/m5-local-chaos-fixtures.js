export const LOCAL_CHAOS_FIXTURE = Object.freeze({
...
export async function validateLocalChaosRenderWorkProduct({
  ...
  if (!valid) throw new Error('local_chaos_render_work_product_drift');
  return {
    verified:true,
...
export function contentVersionWorkProduct() {
  return {
...
export function machineReviewWorkProduct() {
  return {
...
export function systemAgent(id, role) {
  return {
    id,
...
export function addWorkProduct(adapter, caseId, product) {
...
export function workProducts(adapter, caseId) {
