...
const INTENTS = new Set(['identity', 'army_overview', 'army_report', 'usage_report', 'task_progress', 'agent_proposal', 'architecture_review', 'army_planning', 'cross_agent_mission', 'health_check', 'media_task', 'public_report', 'employee_status', 'route_task', 'intake', 'clarify']);
