...
} from './m5-learning-evidence.js';

export { M5LearningLifecycleError } from './m5-learning-evidence.js';

const PROVIDER = 'agent-army.m5-learning';
const RETROSPECTIVE_PROVIDER = 'agent-army.m5-retrospective';
const LEARNING_EVIDENCE = new M5LearningEvidence();
...
export class M5LearningLifecycle {
  ...
  async advance({ caseId, issueId, runId } = {}) {
    ...
    const grayContentVersion = LEARNING_EVIDENCE.selectSingleGrayContent({
    ...
    const outcome = LEARNING_EVIDENCE.evaluateGray({
      outputs:pipelineOutputs,
