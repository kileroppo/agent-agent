...
function stat(label, value, detail, tone = '') { return `<article class="stat ${tone}"><span>${label}</span><strong>${value}</strong><small>${detail}</small></article>`; }
