...
function stat(label: any, value: any, detail: any, tone: any = ''): any { return html`<article class="stat ${tone}"><span>${label}</span><strong>${value}</strong><small>${detail}</small></article>`; }
