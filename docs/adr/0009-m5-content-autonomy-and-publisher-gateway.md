...
7. 本 ADR 最初采用 StepFun 文本主模型，后由 [ADR-0011](./0011-deepseek-primary-reasoning-model.md) 切为 DeepSeek；[ADR-0013](./0013-stepfun-primary-reasoning-restoration.md) 已将 11 个正式岗位恢复为 `stepfun/step-3.7-flash` 且保持空回退链。M5 StepFun 多模态工具仍是独立媒体能力。
