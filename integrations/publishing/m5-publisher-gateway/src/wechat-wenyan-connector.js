...
export class WenyanCliRunner {
  ...
  async createDraft({ files, articlePath, credential, theme = 'default', highlight = 'solarized-light' } = {}) {
...
export class WechatWenyanConnector {
  constructor({ runner, credentialResolver, clock = () => new Date() } = {}) {
...
function validateFiles(files, articlePath) {
...
function validateResolvedCredential(value, request) {
