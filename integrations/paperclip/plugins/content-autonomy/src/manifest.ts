import { M5_PLATFORMS, M5_STEPFUN_MODELS, } from '@agent-army/m5-contracts';
const objectSchema = {
    type: 'object',
        ...
        properties: {
            ...
            agentRoleBindings: {
                ...
                properties: Object.fromEntries([
                    ...
                    'operator',
                    'office-assistant',
                ].map((role: any) => [role, { type: 'string', format: 'uuid' }])),
                required: [
                    'ajun',
                    'intel-researcher',
                    'xiaod',
...
function tool(name: any, displayName: any, description: any, properties: any, required: any) {
